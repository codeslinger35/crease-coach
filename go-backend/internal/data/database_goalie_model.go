...
func (model DatabaseGoalieModel) GetGames(goalieId int64, seasonId int64) ([]Game, error) {
	return nil, nil
}
...
func (model DatabaseGoalieModel) UpdateGame(game Game, goalieId int64, seasonId int64, gameId int64) (Game, error) {
	return Game{}, nil
}
